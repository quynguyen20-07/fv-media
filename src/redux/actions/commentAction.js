import { GLOBAL_TYPES, UpdateData, DeleteData } from './globalTypes'
...
export const updateComment =
  ...
  async (dispatch) => {
    const newComments = UpdateData(post.comments, comment._id, {
      ...comment,
      content
    })
  ...
  async (dispatch) => {
    ...
    const newPost = {
      ...
      comments: post.comments.filter(
        (cmt) => !deleteArray.find((deleteCmt) => cmt._id === deleteCmt._id)
      )
    }
